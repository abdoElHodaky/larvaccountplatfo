                ...
                <div className='p-6'>
                    ...
                    <div className='mb-6'>
                        ...
                        <div className='grid grid-cols-3 gap-4'>
                            ...
                            <div className='text-center'>
                                <div
                                    className={`text-2xl font-bold ${getNetFlowColor(currentPeriod.netFlow)}`}
                                >
                                    {getNetFlowIcon(currentPeriod.netFlow)}{' '}
                                    {formatCurrency(Math.abs(currentPeriod.netFlow))}
                                </div>
                        ...
                        {displayData.slice(1).map((period, index) => (
                            ...
                            >
                                ...
                                <div className='flex items-center space-x-4 text-sm'>
                                    ...
                                    <span
                                        className={`font-medium ${getNetFlowColor(period.netFlow)}`}
                                    >
                                        {getNetFlowIcon(period.netFlow)}{' '}
                                        {formatCurrency(Math.abs(period.netFlow))}
                                    </span>
                                </div>
                            </div>
                        ))}
