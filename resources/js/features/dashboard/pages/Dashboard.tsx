            ...
            <div className='space-y-6'>
                        ...
                        <div className='hidden md:block'>
                            <div className='text-right'>
                                <div className='text-3xl font-bold'>
                                    {stats.organization.total_users}
                                </div>
                        ...
                        <div className='flex items-center'>
                            ...
                            <div className='ml-4'>
                                ...
                                <p className='text-2xl font-semibold text-gray-900'>
                                    {stats.organization.enabled_modules}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='bg-white rounded-lg shadow p-6'>
                            <div className='flex items-center'>
                                ...
                                <div className='ml-4'>
                                    ...
                                    <p className='text-2xl font-semibold text-gray-900'>
                                        {stats.accounting.total_accounts}
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    {quickActions.map((action, index) => (
                                        ...
                                        >
                                            <div className='flex items-center space-x-3'>
                                                <div
                                                    className={`p-2 bg-${action.color}-100 rounded-lg group-hover:bg-${action.color}-200`}
                                                >
                ...
                <div className='bg-white rounded-lg shadow'>
                    <div className='px-6 py-4 border-b border-gray-200'>
                        ...
                        <p className='text-sm text-gray-500'>
                            Active features for your organization
                        </p>
                    </div>
                    <div className='p-6'>
