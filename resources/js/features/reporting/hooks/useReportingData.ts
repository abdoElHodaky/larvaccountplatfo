...
export const useChartData = (chartId: string) => {
    return useRequest(restClient.Get(`/charts/${chartId}/data`), {
        initialData: null,
...
export const useChartsData = (chartIds: string[]) => {
    return useRequest(restClient.Post('/charts/batch', { chart_ids: chartIds }), {
        initialData: [],
...
export const useGenerateReport = () => {
    return useRequest((filters: ReportFilters) => restClient.Post('/reports/generate', filters), {
        immediate: false,
...
export const useDashboardSummary = () => {
    return useRequest(restClient.Get('/reports/dashboard-summary'), {
        initialData: null,
