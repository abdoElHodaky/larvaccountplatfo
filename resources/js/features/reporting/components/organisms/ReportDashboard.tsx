...
export const ReportDashboard: React.FC<ReportDashboardProps> = ({
    ...
    const [activeTab, setActiveTab] = useState<'all' | 'financial' | 'operational' | 'custom'>(
        'all'
    );
    ...
    const defaultReports: Report[] = [
        {
            ...
            description:
                'Comprehensive monthly financial overview including P&L, balance sheet, and cash flow',
            type: 'financial',
            status: 'active',
    ...
    const tabs = [
        { id: 'all', label: 'All Reports', count: displayReports.length },
        {
            id: 'financial',
            label: 'Financial',
            count: displayReports.filter((r) => r.type === 'financial').length,
        },
        {
            id: 'operational',
            label: 'Operational',
            count: displayReports.filter((r) => r.type === 'operational').length,
        },
        {
            id: 'custom',
            label: 'Custom',
            count: displayReports.filter((r) => r.type === 'custom').length,
        },
    ] as const;
                    ...
                    <div className='flex flex-col sm:flex-row gap-4'>
                        ...
                        <div>
                            <select
                                value={sortBy}
                                onChange={(e) =>
                                    setSortBy(e.target.value as 'name' | 'lastRun' | 'createdAt')
                                }
