...
export const ChartContainer: React.FC<ChartContainerProps> = memo(
    ({
        ...
        const chartContent = useMemo(() => {
            ...
            return (
                <Box h={height} w={width} position='relative' overflow='hidden'>
                    {children}
                </Box>
            );
 ...
 */
export const FinancialChartContainer: React.FC<Omit<ChartContainerProps, 'variant'>> = memo(
    (props) => <ChartContainer {...props} variant='financial' />
);
 ...
 */
export const CompactChartContainer: React.FC<Omit<ChartContainerProps, 'variant'>> = memo(
    (props) => <ChartContainer {...props} variant='compact' height={250} />
);
