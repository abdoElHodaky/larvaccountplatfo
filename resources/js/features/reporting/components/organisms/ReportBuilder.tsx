...
export const ReportBuilder: React.FC<ReportBuilderProps> = memo(
    ({ reportId, onSave, onLoad, onExport, className, readOnly = false }) => {
        ...
        if (error) {
            return (
                <Box className={className} p={8} textAlign='center' bg={bgColor} borderRadius='lg'>
            ...
            <DndProvider backend={HTML5Backend}>
                ...
                >
                    ...
                    >
                        ...
                        <Spacer />
                        {lastSaved && <Text>Last saved: {lastSaved.toLocaleTimeString()}</Text>}
                    </HStack>
                </Box>
            </DndProvider>
        );
