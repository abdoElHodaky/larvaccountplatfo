...
export const PieChart: React.FC<PieChartProps> = memo(
    ({
        ...
        const valueFormatter = useMemoizedCallback(
            (value: any) => {
                if (formatValue) {
        ...
        const renderLabel = useMemoizedCallback(
            (entry: any) => {
...
export const DonutChart: React.FC<PieChartProps> = memo((props) => (
    <PieChart {...props} innerRadius={60} outerRadius={100} />
));
...
export const FinancialDonutChart: React.FC<PieChartProps> = memo((props) => (
    <FinancialPieChart {...props} innerRadius={60} outerRadius={100} />
));
