...
export class InventoryApiService {
                ...
                update: (cache, { data: mutationData }) => {
                    ...
                    if (existingItems) {
                        cache.writeQuery({
                            ...
                            data: {
                                inventoryItems: [
                                    ...(existingItems as any).inventoryItems,
                                    mutationData.createInventoryItem,
                                ],
                            },
                        });
                    }
                ...
                update: (cache, { data: mutationData }) => {
                    ...
                    if (existingMovements) {
                        cache.writeQuery({
                            ...
                            data: {
                                stockMovements: [
                                    mutationData.createStockMovement,
                                    ...(existingMovements as any).stockMovements,
                                ],
                            },
                        });
                    }
                    ...
                    if (mutationData.createStockMovement.item) {
                        cache.modify({
                            ...
                            fields: {
                                stockQuantity: () =>
                                    mutationData.createStockMovement.item.stockQuantity,
                            },
                        });
                    }
                },
    ...
    async getWarehouses(): Promise<
        ApiResponse<Array<{ id: string; name: string; location: string }>>
    > {
        try {
            const { data } = await apolloClient.query({
