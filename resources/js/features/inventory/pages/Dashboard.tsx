                        ...
                        <div className='bg-white overflow-hidden shadow rounded-lg'>
                            <div className='p-5'>
                                <div className='flex items-center'>
                                    <div className='flex-shrink-0'>
                                        <div
                                            className={`w-8 h-8 ${stats.lowStockProducts > 0 ? 'bg-red-500' : 'bg-gray-500'} rounded-md flex items-center justify-center`}
                                        >
                                            <svg
                                                className='w-5 h-5 text-white'
                                                fill='currentColor'
                                    ...
                                    <div className='ml-5 w-0 flex-1'>
                                        <dl>
                                            ...
                                            <dd
                                                className={`text-lg font-medium ${stats.lowStockProducts > 0 ? 'text-red-600' : 'text-gray-900'}`}
                                            >
