                                ...
                                <button
                                    onClick={() => {
                                        if (
                                            ...
                                            router.delete(
                                                route('accounting.accounts.destroy', account.id)
                                            );
                                        }
                                    }}
                                ...
                                <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
                                    <div>
                                        <p className='text-sm text-gray-700'>
                                            Showing{' '}
                                            <span className='font-medium'>{accounts.from}</span> to{' '}
                                            <span className='font-medium'>{accounts.to}</span> of{' '}
                                            <span className='font-medium'>{accounts.total}</span>{' '}
                                            results
                                        </p>
                                    </div>
                                    <div>
