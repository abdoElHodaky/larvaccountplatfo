...
import { Transaction, Account, PageProps, PaginatedData } from '@/shared/ICONSIZES';
import { 
    PlusIcon, 
    MagnifyingGlassIcon,
    FunnelIcon,
                            ...
                            <form onSubmit={handleSearch} className="space-y-4">
                                <div className="flex flex-wrap items-center gap-4">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        >
                                            ...
                                            {Object.entries(transactionStatuses).map(([value, label]) => (
                                                <option key={value} value={value}>{label}</option>
                                            ))}
                                        </select>
                                        <select
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        {(search || selectedType || selectedStatus || selectedAccount || dateFrom || dateTo) && (
                                            <button
                                                type="button"
                                            ...
                                            transactions.data.map((transaction) => (
                                                <tr key={transaction.id} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-6 py-4 text-sm text-gray-900">
                                                        ...
                                                        {transaction.notes && (
                                                            <div className="text-xs text-gray-500 max-w-xs truncate">{transaction.notes}</div>
                                                        )}
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getTransactionTypeColor(transaction.type)}`}>
                                                            {transactionTypes[transaction.type] || transaction.type.replace('_', ' ')}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <div className="flex items-center justify-end space-x-2">
                                                            ...
                                                            {transaction.status === 'posted' && !transaction.reversed_at && (
                                                                <button
                                                                ...
                                                                <button
                                                                    onClick={() => {
                                                                        if (confirm('Are you sure you want to delete this transaction?')) {
                                                                            router.delete(route('accounting.transactions.destroy', transaction.id));
                                                                        }
                                                                    }}
