...
import { JournalEntry, PageProps, PaginatedData } from '@/shared/types';
import {
    PlusIcon,
    MagnifyingGlassIcon,
    FunnelIcon,
                    ...
                    <div className='md:flex md:items-center md:justify-between'>
                        <div className='flex-1 min-w-0'>
                            ...
                            <p className='mt-1 text-sm text-gray-500'>
                                Manage your organization's journal entries and double-entry
                                bookkeeping
                            </p>
                        </div>
                                ...
                                <div className='flex flex-wrap items-center gap-4'>
                                    ...
                                    <div className='flex items-center space-x-4'>
                                        ...
                                        >
                                            ...
                                            {Object.entries(journalEntryStatuses).map(
                                                ([value, label]) => (
                                            ...
                                            journalEntries.data.map((entry) => (
                                                <tr key={entry.id} className='hover:bg-gray-50'>
                                                    ...
                                                    <td className='px-6 py-4 whitespace-nowrap'>
                                                        ...
                                                        >
                                                            {journalEntryStatuses[entry.status] ||
                                                                entry.status}
                                                        </span>
                                                    </td>
                                                                    ...
                                                                    <button
                                                                        onClick={() => {
                                                                            if (
                                                                                ...
                                                                                router.delete(
                                                                                    route(
                                                                                        'accounting.journal-entries.destroy',
                                                                                        entry.id
                                                                                    )
                                                                                );
                                                                            }
                                ...
                                <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
                                    <div>
                                        <p className='text-sm text-gray-700'>
                                            ...
                                            to{' '}
                                            <span className='font-medium'>{journalEntries.to}</span>{' '}
                                            of{' '}
                                            <span className='font-medium'>
                                            ...
                                            {journalEntries.links.map((link, index) => (
                                                <Link
                                                    ...
                                                    className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
                                                        ...
                                                        index === journalEntries.links.length - 1
                                                            ? 'rounded-r-md'
                                                            : ''
                                                    }`}
