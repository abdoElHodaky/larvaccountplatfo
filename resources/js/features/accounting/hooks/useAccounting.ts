...
export const useAccounting = () => {
    ...
    return {
        ...
        // Actions
        fetchAccounts: (filters?: Partial<Filters>) => dispatch.accounting.fetchAccounts(filters),
        ...
        deleteAccount: (accountId: string) => dispatch.accounting.deleteAccount(accountId),
        ...
        updateFilters: (filters: Partial<Filters>) => dispatch.accounting.updateFilters(filters),
        resetFilters: () => dispatch.accounting.resetFilters(),
        ...
        initializeAccounting: () => dispatch.accounting.initializeAccounting(),
    };
};
...
export const useAccounts = () => {
    ...
    return {
        ...
        fetch: (filters?: Partial<Filters>) => dispatch.accounting.fetchAccounts(filters),
        create: (accountData: Omit<Account, 'id' | 'createdAt' | 'updatedAt'>) =>
            dispatch.accounting.createAccount(accountData),
        update: (payload: { id: string; data: Partial<Account> }) =>
            dispatch.accounting.updateAccountData(payload),
        delete: (accountId: string) => dispatch.accounting.deleteAccount(accountId),
        select: (account: Account | null) => dispatch.accounting.setSelectedAccount(account),
    };
};
...
export const useTransactions = () => {
    ...
    return {
        ...
        fetch: (filters?: Partial<Filters>) => dispatch.accounting.fetchTransactions(filters),
...
export const useJournalEntries = () => {
    ...
    return {
        ...
        fetch: (filters?: Partial<Filters>) => dispatch.accounting.fetchJournalEntries(filters),
        select: (entry: JournalEntry | null) => dispatch.accounting.setSelectedJournalEntry(entry),
    };
};
...
export const useFilters = () => {
    ...
    return {
        ...
        update: (newFilters: Partial<Filters>) => dispatch.accounting.updateFilters(newFilters),
        reset: () => dispatch.accounting.resetFilters(),
        ...
        setSearchTerm: (term: string) => dispatch.accounting.updateFilters({ searchTerm: term }),
    };
};
...
export const useAccountingStats = () => {
    ...
    const stats = {
        ...
        balancesByType: accounts.reduce(
            (acc, account) => {
