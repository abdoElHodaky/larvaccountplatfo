...
export const accountingModel = createModel<RootModel>()({
    ...
    reducers: {
        ...
        updateAccount: (state, payload: Account) => ({
            ...
            selectedAccount:
                state.selectedAccount?.id === payload.id ? payload : state.selectedAccount,
        }),
        ...
        updateTransaction: (state, payload: Transaction) => ({
            ...
            selectedTransaction:
                state.selectedTransaction?.id === payload.id ? payload : state.selectedTransaction,
        }),
        ...
        removeTransaction: (state, payload: string) => ({
            ...
            selectedTransaction:
                state.selectedTransaction?.id === payload ? null : state.selectedTransaction,
        }),
        ...
        updateJournalEntry: (state, payload: JournalEntry) => ({
            ...
            selectedJournalEntry:
                state.selectedJournalEntry?.id === payload.id
                    ? payload
        ...
        removeJournalEntry: (state, payload: string) => ({
            ...
            selectedJournalEntry:
                state.selectedJournalEntry?.id === payload ? null : state.selectedJournalEntry,
        }),
