...
export const JournalEntries: React.FC<JournalEntriesProps> = ({
    ...
    const defaultEntries: JournalEntry[] = [
        {
            ...
            entries: [
                { account: 'Office Expenses', debit: 150.0, credit: 0 },
                { account: 'Cash', debit: 0, credit: 150.0 },
            ],
            totalDebit: 150.0,
            totalCredit: 150.0,
            isBalanced: true,
        },
        {
            ...
            entries: [
                { account: 'Cash', debit: 2500.0, credit: 0 },
                { account: 'Accounts Receivable', debit: 0, credit: 2500.0 },
            ],
            totalDebit: 2500.0,
            totalCredit: 2500.0,
            isBalanced: true,
        },
        {
            ...
            entries: [
                { account: 'Software Expenses', debit: 99.0, credit: 0 },
                { account: 'Cash', debit: 0, credit: 99.0 },
            ],
            totalDebit: 99.0,
            totalCredit: 99.0,
            isBalanced: true,
    ...
    const filteredEntries = filterPeriod
        ? displayEntries.filter((entry) => entry.date.includes(filterPeriod))
        : displayEntries;
                                        ...
                                        <div className='mt-3 p-3 bg-red-50 border border-red-200 rounded-md'>
                                            <div className='flex items-center'>
                                                <span className='text-red-800 text-sm'>
                                                    ⚠️ This entry is not balanced. Debits and
