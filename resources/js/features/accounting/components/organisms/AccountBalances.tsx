        ...
        <div className={`account-balances ${className}`}>
            ...
            <div className='balances-table'>
                <div className='table-header'>
                    <div className='header-cell sortable' onClick={() => handleSort('code')}>
                    ...
                    <div className='header-cell sortable' onClick={() => handleSort('balance')}>
                    ...
                    {filteredBalances.length === 0 ? (
                        ...
                        filteredBalances.map((balance) => (
                            ...
                            >
                                ...
                                <div
                                    className={`table-cell type ${getAccountTypeColor(balance.accountType)}`}
                                >
                                    {balance.accountType.charAt(0).toUpperCase() +
                                        balance.accountType.slice(1)}
                                </div>
                                <div
                                    className={`table-cell balance ${balance.balance >= 0 ? 'positive' : 'negative'}`}
                                >
