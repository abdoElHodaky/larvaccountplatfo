...
export const TrialBalance: React.FC<TrialBalanceProps> = memo(
    ({
        ...
        const handleAccountClick = useMemoizedCallback(
        ...
        const tableHeader = useMemo(
            ...
            [headerBg, sortBy, sortDirection, handleSort, showComparison, comparisonData]
        );
                    ...
                    {accounts.map((account, index) => {
                        ...
                        const percentChange = comparisonAccount
                            ? ((account.debitBalance +
                                  ...
                                  (comparisonAccount.debitBalance +
                                      comparisonAccount.creditBalance)) /
                                  Math.max(
                                      comparisonAccount.debitBalance +
                                          comparisonAccount.creditBalance,
                                      1
        ...
        const totalsRow = useMemo(
            ...
            [data.totals, formatCurrency, showComparison, comparisonData, headerBg]
        );
            ...
            <CardContainer className={className}>
                <VStack spacing={6} align='stretch'>
                    ...
                    <HStack justify='space-between' fontSize='sm' color='gray.500'>
                        ...
                        <Text>{processedAccounts.length} accounts displayed</Text>
                    </HStack>
                </VStack>
            </CardContainer>
        );
