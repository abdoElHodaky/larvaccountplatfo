...
export const BalanceSheet: React.FC<BalanceSheetProps> = memo(
    ({
        ...
        const renderItemRow = useMemoizedCallback(
            (item: BalanceSheetItem, _index: number) => (
                <Tr
                    key={item.id}
                    _hover={{ bg: hoverBg }}
                ...
                <VStack spacing={4} align='stretch'>
                    ...
                    {!data.totals.isBalanced && (
                        <Alert status='warning' size='sm'>
                            <AlertIcon />
                            <Text fontSize='sm'>
                                Balance sheet is not balanced. Assets do not equal Liabilities +
                                Equity. Variance: {formatCurrency(Math.abs(data.totals.variance))}
                            </Text>
                        </Alert>
                    )}
                </VStack>
                ...
                <SimpleGrid columns={{ base: 2, md: 3, lg: 6 }} spacing={4}>
                    <VStack spacing={1}>
                        ...
                        <Text
                            fontSize='lg'
                            fontWeight='bold'
                            color={data.ratios.currentRatio >= 1 ? positiveColor : negativeColor}
                        >
                    ...
                    <VStack spacing={1}>
                        ...
                        <Text
                            fontSize='lg'
                            fontWeight='bold'
                            color={data.ratios.quickRatio >= 1 ? positiveColor : negativeColor}
                        >
                    ...
                    <VStack spacing={1}>
                        ...
                        <Text
                            ...
                            fontWeight='bold'
                            color={
                                data.ratios.debtToEquityRatio <= 1 ? positiveColor : negativeColor
                            }
                        >
                    ...
                    <VStack spacing={1}>
                        ...
                        <Text
                            ...
                            fontWeight='bold'
                            color={
                                data.ratios.debtToAssetsRatio <= 0.5 ? positiveColor : negativeColor
                            }
                        >
                    ...
                    <VStack spacing={1}>
                        ...
                        <Text
                            fontSize='lg'
                            fontWeight='bold'
                            color={data.ratios.equityRatio >= 0.5 ? positiveColor : negativeColor}
                        >
                    ...
                    <VStack spacing={1}>
                        ...
                        <Text
                            fontSize='lg'
                            fontWeight='bold'
                            color={data.ratios.workingCapital >= 0 ? positiveColor : negativeColor}
                        >
        ...
        const tableContent = useMemo(() => {
            if (viewMode === 'summary') {
                return (
                    <Fragment>
                        ...
                        {renderSectionHeader(
                            'Non-Current Assets',
                            data.totals.totalNonCurrentAssets
                        )}
                        ...
                        {renderSectionHeader(
                            'Current Liabilities',
                            data.totals.totalCurrentLiabilities
                        )}
                        {renderSectionHeader(
                            'Non-Current Liabilities',
                            data.totals.totalNonCurrentLiabilities
                        )}
            ...
            return (
                <Fragment>
                    ...
                    {groupedItems.non_current_asset.map((item, index) =>
                    ...
                    {groupedItems.current_liability.map((item, index) =>
                        renderItemRow(item, index)
                    )}
                    ...
                    {groupedItems.non_current_liability.map((item, index) =>
                        renderItemRow(item, index)
                    )}
