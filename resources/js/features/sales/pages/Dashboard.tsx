            ...
            <div className='space-y-6'>
                        ...
                        <div className='bg-white overflow-hidden shadow rounded-lg'>
                            <div className='p-5'>
                                <div className='flex items-center'>
                                    <div className='flex-shrink-0'>
                                        <div
                                            className={`w-8 h-8 ${overview.monthlyGrowth >= 0 ? 'bg-green-500' : 'bg-red-500'} rounded-md flex items-center justify-center`}
                                        >
                                            <svg
                                                className='w-5 h-5 text-white'
                                                fill='currentColor'
                                    ...
                                    <div className='ml-5 w-0 flex-1'>
                                        <dl>
                                            ...
                                            <dd
                                                className={`text-lg font-medium ${overview.monthlyGrowth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                                            >
                ...
                <div className='bg-white shadow overflow-hidden sm:rounded-md'>
                    <div className='px-4 py-5 sm:px-6'>
                        ...
                        <p className='mt-1 max-w-2xl text-sm text-gray-500'>Latest sales orders</p>
                    </div>
                                    ...
                                    >
                                        <div className='px-4 py-4 sm:px-6'>
                                            <div className='flex items-center justify-between'>
                                                ...
                                                <div className='flex items-center'>
                                                    <div className='text-sm text-gray-900 mr-4'>
                                                        {formatNumber(customer.total_orders || 0)}{' '}
                                                        orders
                                                    </div>
                                                    <div className='text-sm text-gray-500'>
