                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="bg-white overflow-hidden shadow rounded-lg">
                            <div className="p-5">
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <div className={`w-8 h-8 ${stats.monthlyGrowth >= 0 ? 'bg-green-500' : 'bg-red-500'} rounded-md flex items-center justify-center`}>
                                            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd className={`text-lg font-medium ${stats.monthlyGrowth >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm text-gray-500 truncate">Configure organization preferences</p>
                                </div>
                            </Link>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm text-gray-500 truncate">Update organization information</p>
                                </div>
                            </Link>
