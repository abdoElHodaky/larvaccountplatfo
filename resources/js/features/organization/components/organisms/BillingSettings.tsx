                                ...
                                <div className='flex justify-between items-start'>
                                    <div>
                                        ...
                                        <p className='text-sm text-gray-600 mt-2'>
                                            Next billing:{' '}
                                            {formatDate(displayBillingInfo.nextBilling)}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className='mt-2 flex items-center'>
                                            ...
                                            <span className='text-sm text-gray-900'>
                                                {displayBillingInfo.paymentMethod.brand} ending in{' '}
                                                {displayBillingInfo.paymentMethod.last4}
                                            </span>
                                        </div>
                                        {displayBillingInfo.paymentMethod.expiryMonth &&
                                            displayBillingInfo.paymentMethod.expiryYear && (
                                                <p className='text-sm text-gray-600 mt-1'>
                                                    Expires{' '}
                                                    {displayBillingInfo.paymentMethod.expiryMonth}/
                                                    {displayBillingInfo.paymentMethod.expiryYear}
                                ...
                                <div className='flex'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-sm text-yellow-700 mt-1'>
                                            Your payment information is securely processed by our
                                    ...
                                    <div>
                                        ...
                                        <div className='text-sm text-gray-600 space-y-1'>
                                            <p className='font-medium text-gray-900'>
                                                {displayBillingInfo.billingAddress.name}
                                            </p>
                                            <p>{displayBillingInfo.billingAddress.email}</p>
                                            <p>{displayBillingInfo.billingAddress.address}</p>
                                            <p>
                                                {displayBillingInfo.billingAddress.city},{' '}
                                                {displayBillingInfo.billingAddress.state}{' '}
                                                {displayBillingInfo.billingAddress.zipCode}
                                            </p>
                    ...
                    <div className='bg-white rounded-lg shadow-xl max-w-md w-full mx-4'>
                        <div className='p-6'>
                            ...
                            <p className='text-sm text-gray-600 mb-4'>
                                You will be redirected to our secure payment processor to update
                                your payment method.
                            </p>
