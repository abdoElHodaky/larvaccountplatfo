...
export const IntegrationSettings = memo<IntegrationSettingsProps>(
    ({
        ...
        const handleDeleteIntegration = useMemoizedCallback(
        ...
        const handleTestIntegration = useMemoizedCallback(
            async (integrationId: string) => {
        ...
        const handleSyncIntegration = useMemoizedCallback(
            async (integrationId: string) => {
        ...
        const openEditModal = useMemoizedCallback(
                            ...
                            <CardContainer key={integration.id}>
                                <VStack align='stretch' spacing={3}>
                                    <Flex align='center'>
                                        ...
                                        <Spacer />
                                        <Badge
                                            colorScheme={STATUS_COLORS[integration.status]}
                                            variant='subtle'
                                        >
                                            {integration.status}
                                        </Badge>
