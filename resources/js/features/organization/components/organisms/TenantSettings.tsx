...
export const TenantSettings: React.FC<TenantSettingsProps> = ({
    ...
    const [activeTab, setActiveTab] = useState<
        'general' | 'features' | 'branding' | 'notifications'
    >('general');
    ...
    const dateFormats = ['MM/DD/YYYY', 'DD/MM/YYYY', 'YYYY-MM-DD', 'DD-MM-YYYY', 'MM-DD-YYYY'];
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            updateConfig({ fiscalYearStart: e.target.value })
                                        }
                                        placeholder='MM-DD'
                                        className='w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'
                                    />
                                    ...
                                    >
                                        ...
                                        <label className='relative inline-flex items-center cursor-pointer'>
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    updateFeatures(
                                                        feature as keyof TenantConfig['features'],
                                                        e.target.checked
                                                    )
                                                }
                                    ...
                                    >
                                        ...
                                        <label className='relative inline-flex items-center cursor-pointer'>
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    updateNotifications(
                                                        type as keyof TenantConfig['notifications'],
                                                        e.target.checked
                                                    )
                                                }
                                                className='sr-only peer'
