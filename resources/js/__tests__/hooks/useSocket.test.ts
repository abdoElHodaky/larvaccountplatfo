...
describe('useRealtimeDashboard Hook', () => {
    ...
    it('should setup dashboard event listeners', () => {
        ...
        expect(mockSocketManager.on).toHaveBeenCalledWith(
            'dashboard:widget_position_updated',
            expect.any(Function)
        );
        expect(mockSocketManager.on).toHaveBeenCalledWith(
...
describe('useRealtimeAccounting Hook', () => {
    ...
    it('should setup accounting event listeners', () => {
        ...
        expect(mockSocketManager.on).toHaveBeenCalledWith(
            'accounting:transaction_created',
            expect.any(Function)
        );
        expect(mockSocketManager.on).toHaveBeenCalledWith(
            'accounting:transaction_updated',
            expect.any(Function)
        );
        expect(mockSocketManager.on).toHaveBeenCalledWith(
            'accounting:account_balance_updated',
            expect.any(Function)
        );
    });
