...
// Accounting Pages
export const AccountsPage = lazyWithRetry(() => import('../../features/accounting/pages/Accounts'));
...
export const WebSocketProvider = lazyWithRetry(() => import('../providers/WebSocketProvider'));
...
// Auth Pages
export const LoginPage = lazyWithRetry(() => import('../../features/auth/pages/Login'));

export const RegisterPage = lazyWithRetry(() => import('../../features/auth/pages/Register'));
...
export const componentBundles = {
    ...
    organization: ['OrganizationSettings', 'UserManagementOrg'],
    reporting: [
        'IncomeStatement',
        'BalanceSheet',
        'TrialBalance',
    ...
    settings: ['TenantSettings', 'UserManagement', 'IntegrationSettings', 'BillingSettings'],
};
