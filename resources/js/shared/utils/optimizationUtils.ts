...
if (typeof window !== 'undefined') {
  ...
  BundleSplitter.registerChunk('accounting', () => import('../../features/accounting/pages/Accounts'));
  BundleSplitter.registerChunk('inventory', () => import('../../features/inventory/stores/inventoryModel'));
  BundleSplitter.registerChunk('dashboard', () => import('../../features/dashboard/stores/dashboardModel'));
