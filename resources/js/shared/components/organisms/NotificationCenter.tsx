...
export const NotificationCenter: React.FC<NotificationCenterProps> = memo(
    ({ tenantId, maxNotifications = 50, autoMarkAsRead = true, showToasts = true, className }) => {
        ...
        // Show toast notification
        const showToastNotification = useMemoizedCallback(
        ...
        const handleNotificationClick = useMemoizedCallback(
            (notification: Notification) => {
        ...
        return (
            ...
            >
                ...
                <PopoverContent w='380px' bg={bgColor} borderColor={borderColor}>
                    ...
                    <PopoverBody p={0}>{notificationList}</PopoverBody>
                </PopoverContent>
            </Popover>
        );
    }
