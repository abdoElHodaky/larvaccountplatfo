...
import { Box, VStack, HStack, IconButton, useColorModeValue } from '@chakra-ui/react';
...
export const SwipeableCards: React.FC<SwipeableCardsProps> = memo(
    ({
        ...
        return <Box className={className}>{cards}</Box>;
    }
);
...
const SwipeableCard: React.FC<SwipeableCardProps> = memo(
    ({
        ...
        const handleActionClick = useMemoizedCallback(
 ...
 */
export const FinancialSwipeableCards: React.FC<
    Omit<SwipeableCardsProps, 'leftActions' | 'rightActions'> & {
        onEdit?: (item: any) => void;
        onDelete?: (item: any) => void;
        onArchive?: (item: any) => void;
        onFavorite?: (item: any) => void;
    }
> = memo(({ onEdit, onDelete, onArchive, onFavorite, ...props }) => {
    ...
    return <SwipeableCards {...props} leftActions={leftActions} rightActions={rightActions} />;
});
