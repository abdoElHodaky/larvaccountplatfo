...
function PrimaryButton({
    ...
    const variantClasses = {
        primary:
            'bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 text-white border border-transparent',
        secondary:
            'bg-white hover:bg-gray-50 focus:ring-blue-500 text-gray-700 border border-gray-300',
        danger: 'bg-red-600 hover:bg-red-700 focus:ring-red-500 text-white border border-transparent',
        success:
            'bg-green-600 hover:bg-green-700 focus:ring-green-500 text-white border border-transparent',
    };
