...
export const PageTemplate: React.FC<PageTemplateProps> = ({
    ...
    const pageClasses = cn('min-h-screen bg-gray-50 dark:bg-gray-900', className);

    const mainClasses = cn('flex-1', showSidebar && 'lg:pl-64');

    const contentClasses = cn('py-6', loading && 'opacity-50 pointer-events-none');
