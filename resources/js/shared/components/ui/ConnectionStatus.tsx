...
import { FiWifi, FiWifiOff, FiLoader, FiAlertCircle, FiCheck, FiX, FiClock } from 'react-icons/fi';
import { useConnectionStatus } from '../../hooks/useRealTime';

export const ConnectionStatus: React.FC = () => {
    const { isConnected, isConnecting, connectionError, reconnectAttempts, connectionHistory } =
        useConnectionStatus();
    ...
    const StatusIndicator = () => (
        <HStack spacing={2}>
            ...
            <Badge colorScheme={getStatusColor()} variant='subtle' size='sm'>
                Real-time
            </Badge>
        </HStack>
    );
