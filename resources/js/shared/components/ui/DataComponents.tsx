...
import { TableProps, TableColumn, CardProps, BadgeProps, AvatarProps, Size, ColorScheme } from './types';
    ...
    return (
      ...
      >
        ...
        {(title || subtitle || actions) && (
          <div className={cn('flex items-start justify-between', sizeStyles.padding, 'border-b border-gray-200 dark:border-gray-700')}>
...
export const List = forwardRef<HTMLDivElement, ListProps>(
  ({ items, loading = false, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn('bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700', className)}
        {...props}
      >
        {items.map((item) => (
          <div
