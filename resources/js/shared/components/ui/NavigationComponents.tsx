...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    const variantClasses = {
        ...
        floating:
            'bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 m-4',
        bordered:
    ...
    return (
        <nav className={cn('flex items-center justify-center space-x-1', className)}>
            ...
            {visiblePages.map((page, index) => (
                <Fragment key={index}>
                    {page === '...' ? (
                        <span className={cn('text-gray-500', sizeClasses[size])}>...</span>
                    ) : (
                        <button
...
export { Sidebar, Breadcrumb, Navbar, Pagination };
