...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variantClasses = {
      ...
      link: {
        primary: 'text-primary-600 hover:text-primary-700 underline-offset-4 hover:underline focus:ring-primary-500',
        asset: 'text-green-600 hover:text-green-700 underline-offset-4 hover:underline focus:ring-green-500',
        liability: 'text-red-600 hover:text-red-700 underline-offset-4 hover:underline focus:ring-red-500',
...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ 
    ...
    const baseClasses = 'block w-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed';
