...
export const FormField = forwardRef<HTMLDivElement, FormFieldProps>(
    ({ label, description, error, required, optional, children, className, ...props }, ref) => {
        return (
...
export const NumberInput = forwardRef<HTMLInputElement, NumberInputProps>(
    ({ value, onChange, min, max, step = 1, precision = 2, format = 'decimal', ...props }, ref) => {
...
export const CurrencyInput = forwardRef<HTMLInputElement, CurrencyInputProps>(
    ({ currency = 'USD', locale = 'en-US', showSymbol = true, value, onChange, ...props }, ref) => {
        ...
        const uploadArea = (
            ...
            >
                ...
                <div className='mt-4'>
                    ...
                    {dragAndDrop && <span className='text-gray-500'> or drag and drop</span>}
                </div>

                {accept && <p className='mt-2 text-xs text-gray-500'>Accepted formats: {accept}</p>}
