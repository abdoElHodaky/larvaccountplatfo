...
import { cn, getSizeClasses, getColorClasses, formatCurrency, getAccountingColorClasses } from './utils';
import { AccountingAmount, TransactionRowProps, FinancialSummaryProps, Size, ColorScheme } from './types';
...
export const AccountSelector = forwardRef<HTMLDivElement, AccountSelectorProps>(
  ({ 
    ...
    return (
      <Combobox value={value} onChange={(accountId) => {
        ...
        <div ref={ref} className={cn('relative', className)} {...props}>
          <div className="relative w-full cursor-default overflow-hidden rounded-md border bg-white text-left shadow-sm focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-primary-500">
            <Combobox.Input
              ...
              displayValue={() => selectedAccount ? `${selectedAccount.code} - ${selectedAccount.name}` : ''}
  ...
  ({ 
    ...
    return (
      ...
      >
        ...
        <div className={cn(
          'text-sm text-right font-mono',
          credit ? getAccountingColorClasses('credit', credit.amount) : 'text-gray-400'
        )}>
          {credit ? (
            <span>
        ...
        <div className={cn(
          ...
          balance ? getAccountingColorClasses('balance', balance.amount) : 'text-gray-400'
        )}>
          {balance ? (
            <span>
