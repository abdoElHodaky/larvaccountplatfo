...
export const Container = forwardRef<HTMLDivElement, ContainerProps>(
    ({ size = 'lg', centered = true, fluid = false, className, children, ...props }, ref) => {
        const sizeClasses = {
            sm: 'max-w-sm',
            md: 'max-w-md',
            lg: 'max-w-4xl',
...
export const Stack = forwardRef<HTMLDivElement, StackProps>(
    ({ spacing = 4, divider, children, className, ...props }, ref) => {
        const childrenArray = React.Children.toArray(children);

        return (
            <Flex ref={ref} direction='col' gap={spacing} className={className} {...props}>
                {divider
...
export const HStack = forwardRef<HTMLDivElement, HStackProps>(
    ({ spacing = 4, divider, children, className, ...props }, ref) => {
        ...
        return (
            <Flex ref={ref} direction='row' gap={spacing} className={className} {...props}>
                {divider
                    ? childrenArray.map((child, index) => (
                          <React.Fragment key={index}>
                              {child}
...
export const Spacer: React.FC<SpacerProps> = ({ size = 4, axis = 'both', className }) => {
    const sizeClasses = {
        x: {
            0: 'w-0',
            1: 'w-1',
    ...
    return <div className={cn('flex-shrink-0', sizeClasses[axis][size], className)} />;
};
...
export { Container, Grid, GridItem, Flex, Stack, HStack, Spacer, Center, AspectRatio };
