...
export function useFormValidation(
  ...
  const validateSingleRule = useMemoizedCallback(async (
    value: any,
    rule: ValidationRule,
    fieldName: string,
    signal?: AbortSignal
  ...
  const validateField = useMemoizedCallback(async (
    fieldName: string,
    value: any
  ...
  const validate = useMemoizedCallback(async (fieldName?: string): Promise<boolean> => {
  ...
  const setFieldTouched = useMemoizedCallback((
    fieldName: string,
