...
export const enhancedPageRegistry: PageRegistry = {
    ...
    'auth/Login': createLazyPage(() => import('@/features/auth/pages/Login'), {
    ...
    'auth/Register': createLazyPage(() => import('@/features/auth/pages/Register'), {
    ...
    'auth/ForgotPassword': createLazyPage(() => import('@/features/auth/pages/ForgotPassword'), {
    ...
    'auth/ResetPassword': createLazyPage(() => import('@/features/auth/pages/ResetPassword'), {
    ...
    // Dashboard Pages
    'dashboard/Index': createLazyPage(() => import('@/features/dashboard/pages/Dashboard'), {
    ...
    // Accounting Pages
    'accounting/Dashboard': createLazyPage(() => import('@/features/accounting/pages/Dashboard'), {
    ...
    // Inventory Pages
    'inventory/Dashboard': createLazyPage(() => import('@/features/inventory/pages/Dashboard'), {
    ...
    // Organization Pages
    'organization/Index': createLazyPage(() => import('@/features/organization/pages/Index'), {
    ...
    // Sales Pages
    'sales/Dashboard': createLazyPage(() => import('@/features/sales/pages/Dashboard'), {
    ...
    // Reporting Pages
    'reporting/Dashboard': createLazyPage(() => import('@/features/reporting/pages/Dashboard'), {
