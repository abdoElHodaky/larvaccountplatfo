...
class StockLevelUpdated implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            'stock_level' => [
                ...
                'unit_cost' => $this->stockLevel->unit_cost,
                'total_value' => $this->stockLevel->total_value,
                'stock_status' => $this->stockLevel->stock_status,
                'stock_status_color' => $this->stockLevel->stock_status_color,
                'is_low_stock' => $this->stockLevel->isLowStock(),
                'last_movement_date' => $this->stockLevel->last_movement_date?->toISOString(),
                'updated_at' => $this->stockLevel->updated_at->toISOString(),
            ],
